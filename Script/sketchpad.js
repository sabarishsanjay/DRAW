...
function Sketchpad(config) {
  ...
  this.penSize = config.penSize || this.element.attr('data-penSize') || 2;
...
Sketchpad.prototype.reanimate = function(strokes,ms, loop, loopDelay) {
...
Sketchpad.prototype.animate = function(ms, loop, loopDelay) {
  ...
  var j=JSON.stringify(this.toObject());
...
Sketchpad.prototype.undo = function() {
  ...
  if (stroke) {
    var s = localStorage.getItem('j');
    this.undoHistory.push(stroke);
    this.redraw(this.strokes);
    j.undoHistory.push(stroke);
...
Sketchpad.prototype.reload = function(){
